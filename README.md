...
这是[阿木](https://earfanfan.github.io/amu-blog/)的博客，这份说明给共同维护者使用，只在 GitHub 网页就能完成内容更新（复杂的更新pull到本地再push更方便）。
...
PS：注释相关数据可以隐藏特定照片，也可以修改已有照片的标题
...
## 常用地址
- [博客地址](https://earfanfan.github.io/amu-blog/)
